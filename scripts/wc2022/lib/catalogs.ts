...
// These are not loaded from JSON because they are stable across editions
// (until FIFA changes the format) and they are easier to reason about
// when colocated with the seeder code.
//
...
// They are kept here only so the column has a sensible non-default value
// at insert time.
